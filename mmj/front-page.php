...
<div id="index-vue" class="">
     ...
     <div class="top_banner_block hide-for-large">
       ...
       ?>
         ...
         <?php while ( $posts->have_posts() ) :
           ...
           <p class="top_news_block--title"><?php the_title(); ?></p>
         </a>
       <?php endwhile; ?>
     ...
     <?php echo do_shortcode('[metaslider id="12265"]'); ?>				
     ...
     <?php echo do_shortcode('
       [su_row][su_column size="1/2"][metaslider id="12256"][/su_column]
       [su_column size="1/2"][metaslider id="12263"][/su_column][/su_row]')
     ; ?>	
...
<h2 class="article_card--title"><?php the_title(); ?></h2>
	...
	<?php
          echo"<center><h2>WEEKLY RECOMMEND</h2></center>"
         ?>			
...
<?php
$top5str = implode(",",$top5);
echo do_shortcode( '[ajax_load_more post_type="post" css_classes="list--repeat row" posts_per_page="21" transition="fade" transition_container="false" scroll_distance="10" button_label="Loading more..." button_loading_label="Loading more..." post__not_in="' .$top5str.'"]' ); ?>
